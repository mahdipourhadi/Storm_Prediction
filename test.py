...
validate_days = ['2018-06-11']

##test_days = ['2018-06-12']
...
for i in range(10):
    ...
    print('Iteration: '+str(i+1)+ ' from 10')

    class_weight = {0: .1,
                1: 1.}

    checkpoint = ModelCheckpoint(Folder_Name +'/modelfinal-{epoch:02d}-{val_binary_accuracy:.4f}.hdf5', monitor='val_binary_crossentropy', verbose=1, save_best_only=True, mode='min')
