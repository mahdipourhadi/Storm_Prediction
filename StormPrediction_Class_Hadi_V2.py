...
class Data_Generator(keras.utils.Sequence):
    def __init__(self, filenames, num_files, num_members, parameters, scaler,ipca):
        self.filenames = filenames
...
#        self.scaler.fit(xTrain.astype(float))
        ...
        xTrain = self.ipca.transform(xTrain)
...
class Test_Generator(keras.utils.Sequence):
    def __init__(self, filenames, parameters, model, scaler, ipca):
        self.filenames = filenames
        self.parameters = parameters
        self.model = model
        self.scaler = scaler
    ...
    def __getitem__(self, idx):
        ...
        xTest = self.ipca.transform(xTest)
#        xTest = self.scaler.fit_transform(xTest.astype(float))
        ...
        #Test = Test.groupby(['Lat', 'Lon', 'TimeSlot', 'Range'])['y_actual','y_pred'].mean()
...
class Permutation(keras.utils.Sequence):
    ...
    def __init__(self, filenames, parameters, model, scaler, ipca, param):
        self.filenames = filenames
        self.parameters = parameters
        self.model = model
        self.scaler = scaler
