...
#destination_dir='/home/asap/Hadi/ISOBAR/Data/Fused_Data_V1/'
destination_dir='/mnt/dav/Codes_Output/IsoBar_Fused_Data_V1/'
#r = requests.get(destination_dir,auth=('hmahdipo', 'Mahdipour@1363'))
#requests.get(destination_dir, auth=HTTPBasicAuth('hmahdipo', 'Mahdipour@1363'))
