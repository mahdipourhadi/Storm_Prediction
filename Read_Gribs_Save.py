...
gribfiles = glob.glob(r'Z:\EPS\ECM*\2019-06-18*\*.grib')
...
path_out = r'Z:\Codes_Output\Lightning_Data'
#path_out = r'D:\TmpData'
#path_out = r'Z:\hmahdipo\Test_Lightening'
...
GEO = pd.read_pickle(r'D:\postdoc_hadi\ISOBAR\Code\ReadGribsFiles\GEO')
...
[getEPS_DF(file,Params,GEO,n,path_out) for file in gribfiles[:2]]

#%% View the output files

processed_files = glob.glob(path_out+r'\*')
