...
Storms_Sattlite_Files = glob.glob('/home/asap/Hadi/ISOBAR/Code/ReadGribsFiles/Storms/Storms_Sattlite_2019*')
Storms_Sattlite_Files.sort()

#Data_Bef_Storm_Dir=r'Z:\Codes_Output\Lightning_Data'
Data_Bef_Storm_Dir='/mnt/dav/Codes_Output/Lightning_Data'
